  ...
  return (
    <section className="bg-white py-12 px-6 text-center">
      <h2 className="text-4xl font-bold mb-4">
        <span className="bg-green-500 text-black px-3 py-1 rounded">Testimonials</span>
      </h2>
      ...
      >
        {testimonials.map((testimonial, index) => (
          <SwiperSlide key={index}>
            <div className="bg-gray-900 text-white p-8 rounded-2xl border border-green-500 text-lg relative">
              ...
              <h4 className="text-green-400 font-bold">{testimonial.name}</h4>
      ...
      <div className="flex justify-center items-center mt-4 gap-4">
        <button ref={prevRef} className="p-3 bg-green-500 text-white rounded-full hover:bg-green-600">
          <FaChevronLeft size={20} />
        </button>
        <button ref={nextRef} className="p-3 bg-green-500 text-white rounded-full hover:bg-green-600">
